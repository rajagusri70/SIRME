  ...
  //   	return $this->db->get('pasien');
	...
	public function input($upload){
		...
		$data = array(
			...
			"nama_penanggungjawab" => $this->input->post('input_nama_penanggungjawab'),
			"hubungan_penanggungjawab" => $this->input->post('input_hubungan_penanggungjawab'),
			"no_telpon_penanggungjawab" => $this->input->post('input_no_telpon_penanggungjawab'),
