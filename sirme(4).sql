...
--
-- Host: 127.0.0.1
-- Generation Time: May 30, 2018 at 05:05 AM
...
(6, 180, '20:53:38', '', 'Disertai dengan air');
...
(180, 25, 1, '29-05-2018', '20:50:27', '29-05-2018', '21:04:44');
...
INSERT INTO `tb_riwayat_alergi` (`id_alergi`, `no_pasien`, `jam_input`, `organ_sasaran`, `gejala`, `bahan_kimia`, `keterangan`) VALUES
...
INSERT INTO `tb_riwayat_penyakit` (`id_riwayat`, `no_pasien`, `tanggal_input`, `jam_input`, `kode_icd10`, `diagnosa`) VALUES
(2, 1003, '27-05-2018', '23:01:35', 'R50.9', 'Tiper'),
(6, 1003, '28-05-2018', '00:34:15', 'J45.30', 'Asma'),
(10, 1004, '29-05-2018', '20:52:25', 'L50.0', 'Biduran');
...
(21, 180, 'Baik', 'Cemas', 'Sopor', '55', '44', '55', '33', '44', '55', '33', 'Tidak Ada', 'Tidak', 'Tidak', 'Tidak');
...
(4, 180, 'Mandiri', 'Tidak', 'Tidak', 'Tidak Beresiko', 'Tidak Ada Nyeri', 'Agak Mengganggu ', 'Bahu', 'Nyeri', 'Kadang-kadang', 'Setiap bangun tidur', 'Istirahat');
...
--
ALTER TABLE `rawat_jalan`
  MODIFY `id_rawat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
--
...
--
ALTER TABLE `tb_penatalaksanaan`
  MODIFY `id_penatalaksanaan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT for table `tb_periksa`
--
ALTER TABLE `tb_periksa`
  MODIFY `id_periksa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=181;
--
...
--
ALTER TABLE `tb_riwayat_hamil`
  MODIFY `id_hamil` int(11) NOT NULL AUTO_INCREMENT;
--
